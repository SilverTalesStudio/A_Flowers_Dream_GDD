...
Para finalizar la tercera semana, la Florista vuelve a hablar con su amiga para que el jugador pueda obtener un resumen del nivel de afinidad con cada personaje. El jugador quedará con aquel personaje con el que tenga mayor afinidad y este será con el que desbloquee el final bueno (relación amorosa).  <br></br>
